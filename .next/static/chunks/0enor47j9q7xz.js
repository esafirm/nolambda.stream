;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (u) => {
    ...
    var D = u.i(15497),
      ...
      e = u.i(81272),
      C = u.i(72130)
    function E({ totalPages: u, currentPage: F }) {
      let C = parseInt(F) - 1 > 0,
    ...
    u.s(
      [
        'default',
        0,
        function ({ posts: u, title: t, initialDisplayPosts: s = [], pagination: a }) {
          let [r, B] = (0, F.useState)(''),
            i = u.filter((u) =>
              (u.title + u.summary + u.tags.join(' ')).toLowerCase().includes(r.toLowerCase())
            ),
            l = s.length > 0 && !r ? s : i
          return (0, D.jsxs)(D.Fragment, {
            children: [
                ...
                children: [
                  ...
                  (0, D.jsxs)('ul', {
                    children: [
                      ...
                      l.map((u) => {
                        let { slug: F, date: E, title: t, summary: s, tags: a } = u
                        return (0, D.jsx)(
                          'li',
                          {
                            className: 'py-4',
              ...
              a &&
                a.totalPages > 1 &&
                !r &&
                (0, D.jsx)(E, { currentPage: a.currentPage, totalPages: a.totalPages }),
            ],
          })
        },
      ],
  ...
  (u, D, F) => {
    ...
    let e = u.r(2879)._(u.r(50394)),
      C = u.r(67104),
      E = e.default.createContext(C.imageConfigDefault)
  },
  18033,
  (u) => {
    'use strict'
    ...
    u.s([
      ...
      'default',
      0,
      function ({ posts: u, initialDisplayPosts: E, pagination: A }) {
        return (0, D.jsxs)(D.Fragment, {
          children: [
            (0, D.jsx)(F.PageSEO, { title: e.default.title, description: e.default.description }),
            (0, D.jsx)(C.default, {
              posts: u,
              initialDisplayPosts: E,
              pagination: A,
              title: 'All Posts',
            }),
          ],
  ...
  84998,
  (u, D, F) => {
    let e = '/posts/page/[page]'
    ;(window.__NEXT_P = window.__NEXT_P || []).push([e, () => u.r(18033)]),
      D.hot &&
