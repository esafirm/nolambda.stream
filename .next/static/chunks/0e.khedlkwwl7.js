;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (u) => {
    ...
    u.s(
      [
        'default',
        0,
        function ({ posts: u, title: s, initialDisplayPosts: C = [], pagination: l }) {
          let [n, E] = (0, F.useState)(''),
            i = u.filter((u) =>
              (u.title + u.summary + u.tags.join(' ')).toLowerCase().includes(n.toLowerCase())
            ),
            A = C.length > 0 && !n ? C : i
            ...
            children: [
              (0, D.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, D.jsxs)('ul', {
                    children: [
                      !i.length && 'No posts found.',
                      A.map((u) => {
                        let { slug: F, date: r, title: s, summary: C, tags: l } = u
                        return (0, D.jsx)(
                          'li',
                          {
                            className: 'py-4',
              ...
              l &&
                l.totalPages > 1 &&
                !n &&
                (0, D.jsx)(r, { currentPage: l.currentPage, totalPages: l.totalPages }),
            ],
          })
        },
      ],
    ...
    let B = {
      mail: function (u) {
        return l.createElement(
          'svg',
          n({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 20 20' }, u),
          D ||
      ...
      github: function (u) {
        return l.createElement(
          'svg',
          E({ viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' }, u),
          e ||
      ...
      facebook: function (u) {
        return l.createElement(
          'svg',
          i({ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 24 24' }, u),
          t ||
      ...
      [
        ...
        ({ kind: u, href: D, size: F = 8 }) => {
          ...
          return (0, C.jsxs)('a', {
            ...
            href: D,
            children: [
              (0, C.jsx)('span', { className: 'sr-only', children: u }),
              (0, C.jsx)(e, {
    ...
    let t = ({ title: u = 'Subscribe to the newsletter' }) => {
      let t = (0, F.useRef)(null),
        ...
        E = async (u) => {
          ...
          if (F) {
            a(!0), C('Your e-mail address is invalid or you are already subscribed!')
            return
          }
          ;(t.current.value = ''), a(!1), n(!0), C('Successfully! 🎉 You are now subscribed.')
        }
      return (0, D.jsxs)('div', {
        children: [
          (0, D.jsx)('div', {
              ...
              (0, D.jsxs)('div', {
                children: [
                  ...
                  (0, D.jsx)('input', {
                    ...
                    id: 'email-input',
                    name: 'email',
                    placeholder: l ? "You're subscribed !  🎉" : 'Enter your email',
                    ref: t,
                    required: !0,
                    type: 'email',
                    disabled: l,
              ...
              (0, D.jsx)('div', {
                ...
                children: (0, D.jsx)('button', {
                  className: `w-full rounded-md bg-primary-500 px-4 py-2 font-medium text-white sm:py-0 ${
                    l ? 'cursor-default' : 'hover:bg-primary-700 dark:hover:bg-primary-400'
                  } focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 dark:ring-offset-black`,
                  type: 'submit',
                  disabled: l,
                  children: l ? 'Thank you!' : 'Sign up',
                }),
              }),
            ],
          }),
  ...
  (u) => {
    ...
    u.s([
      ...
      'default',
      0,
      function ({ authorDetails: u }) {
        let { mdxSource: e, frontMatter: t } = u
        return (0, D.jsx)(F.MDXLayoutRenderer, { layout: t.layout, mdxSource: e, frontMatter: t })
      },
    ])
  },
  75689,
  (u, D, F) => {
    let e = '/talks'
    ;(window.__NEXT_P = window.__NEXT_P || []).push([e, () => u.r(26130)]),
      D.hot &&
