;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (u) => {
    ...
    u.s(
      [
        'default',
        0,
        function ({ posts: u, title: t, initialDisplayPosts: a = [], pagination: r }) {
          let [s, B] = (0, F.useState)(''),
            i = u.filter((u) =>
              (u.title + u.summary + u.tags.join(' ')).toLowerCase().includes(s.toLowerCase())
            ),
            l = a.length > 0 && !s ? a : i
          return (0, D.jsxs)(D.Fragment, {
            children: [
                ...
                children: [
                  ...
                  (0, D.jsxs)('ul', {
                    children: [
                      ...
                      l.map((u) => {
                        let { slug: F, date: E, title: t, summary: a, tags: r } = u
                        return (0, D.jsx)(
                          'li',
                          {
                            className: 'py-4',
              ...
              r &&
                r.totalPages > 1 &&
                !s &&
                (0, D.jsx)(E, { currentPage: r.currentPage, totalPages: r.totalPages }),
            ],
          })
        },
      ],
  ...
  (u) => {
    ...
    u.s([
      ...
      'default',
      0,
      function ({ posts: u, tag: E }) {
        let A = E[0].toUpperCase() + E.split(' ').join('-').slice(1)
        return (0, D.jsxs)(D.Fragment, {
          children: [
            (0, D.jsx)(F.TagSEO, {
              title: `${E} - ${e.default.author}`,
              description: `${E} tags - ${e.default.author}`,
            }),
            (0, D.jsx)(C.default, { posts: u, title: A }),
          ],
        })
      },
    ])
  ...
  (u, D, F) => {
    let e = '/tags/[tag]'
    ;(window.__NEXT_P = window.__NEXT_P || []).push([e, () => u.r(54317)]),
      D.hot &&
