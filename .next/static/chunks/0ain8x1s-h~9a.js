;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
                ...
                for (let t = 0, n = p.length; t < n; t++) {
                  ...
                  if (e.props.hasOwnProperty(n))
                    if ('charSet' === n) r.has(n) ? (i = !1) : r.add(n)
                      ...
                      let t = e.props[n],
                        r = o[n] || new Set()
                      ;('name' !== n || !l) && r.has(t) ? (i = !1) : (r.add(t), (o[n] = r))
                    }
                }
            }
            return i
    ...
    let y = function ({ children: e }) {
      ...
      return (0, a.jsx)(s.default, { reduceComponentsToState: h, headManager: t, children: e })
    }
  ...
  (e, t, n) => {
    ...
    function d({ req: t, res: n, err: r }) {
      ...
      if ('u' > typeof window) o = window.location.hostname
        ...
        let { getRequestMeta: n } = e.r(70909),
          r = n(t, 'initURL')
          ...
          children: [
            ...
            (0, o.jsxs)('div', {
              ...
              children: [
                ...
                e ? (0, o.jsx)('h1', { className: 'next-error-h1', style: c, children: e }) : null,
                (0, o.jsx)('div', {
                  style: p,
