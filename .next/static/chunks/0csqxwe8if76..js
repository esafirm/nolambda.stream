;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (u, D, F) => {
    ...
    for (var C in e) Object.defineProperty(F, C, { enumerable: !0, get: e[C] })
  ...
  (u, D, F) => {
    ...
    let e = u.r(2879)._(u.r(50394)),
      C = u.r(67104),
      t = e.default.createContext(C.imageConfigDefault)
  },
  41283,
  (u, D, F) => {
    D.exports =
  ...
  (u, D, F) => {
    ...
    ;(t.prototype.slug = function (u, D) {
      let F = E(u, !0 === D),
        e = F
      for (; C.call(this.occurrences, F); )
  ...
  (u) => {
    ...
    var D = u.i(15497),
      F = u.i(50394),
      e = u.i(89973)
    let C = ({ title: u = 'Subscribe to the newsletter' }) => {
      let C = (0, F.useRef)(null),
        ...
        i = async (u) => {
          ...
          if (F) {
            E(!0), s('Your e-mail address is invalid or you are already subscribed!')
            return
          }
          ;(C.current.value = ''), E(!1), r(!0), s('Successfully! 🎉 You are now subscribed.')
        }
      return (0, D.jsxs)('div', {
        children: [
          (0, D.jsx)('div', {
              ...
              (0, D.jsxs)('div', {
                children: [
                  ...
                  (0, D.jsx)('input', {
                    ...
                    id: 'email-input',
                    name: 'email',
                    placeholder: a ? "You're subscribed !  🎉" : 'Enter your email',
                    ref: C,
                    required: !0,
                    type: 'email',
                    disabled: a,
              ...
              (0, D.jsx)('div', {
                ...
                children: (0, D.jsx)('button', {
                  className: `w-full rounded-md bg-primary-500 px-4 py-2 font-medium text-white sm:py-0 ${
                    a ? 'cursor-default' : 'hover:bg-primary-700 dark:hover:bg-primary-400'
                  } focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 dark:ring-offset-black`,
                  type: 'submit',
                  disabled: a,
                  children: a ? 'Thank you!' : 'Sign up',
                }),
              }),
            ],
          }),
    ...
    u.s([
      ...
      function ({ posts: u }) {
        return (0, D.jsxs)(D.Fragment, {
          children: [
            (0, D.jsx)(e.PageSEO, { title: t.default.title, description: t.default.description }),
            (0, D.jsxs)('div', {
                ...
                (0, D.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, D.jsx)('p', {
                      ...
                      children: t.default.description,
                    }),
                  ],
                }),
                (0, D.jsxs)('ul', {
                  ...
                  children: [
                    ...
                    u.slice(0, 5).map((u) => {
                      let { slug: e, date: t, title: A, summary: s, tags: a } = u
                      return (0, D.jsx)(
                        'li',
                        {
                          className: 'py-12',
  ...
  21899,
  (u, D, F) => {
    ;(window.__NEXT_P = window.__NEXT_P || []).push(['/', () => u.r(10477)]),
      D.hot &&
