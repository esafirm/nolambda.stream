    ...
    a.a(async (b, c) => {
      try {
        var d = a.i(8171),
          ...
          g = b([f])
        async function h() {
          return { props: { authorDetails: await (0, f.getFileBySlug)('authors', ['default']) } }
        }
        ;([f] = g.then ? (await g)() : g),
          a.s([
            'default',
            0,
            function ({ authorDetails: a }) {
              let { mdxSource: b, frontMatter: c } = a
              return (0, d.jsx)(e.MDXLayoutRenderer, {
                layout: c.layout || 'AuthorLayout',
                mdxSource: b,
                frontMatter: c,
              })
            },
...
//# sourceMappingURL=_0m88xbv._.js.map
