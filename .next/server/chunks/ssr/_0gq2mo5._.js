    ...
    a.a(async (b, c) => {
      try {
        var d = a.i(8171),
          ...
          j = b([g, i])
        async function k() {
          let a = await (0, g.getAllFilesFrontMatter)('posts'),
            b = Math.ceil(a.length / i.POSTS_PER_PAGE)
          return {
            paths: Array.from({ length: b }, (a, b) => ({ params: { page: (b + 1).toString() } })),
            fallback: !1,
          }
        }
        async function l(a) {
          let {
            ...
            c = await (0, g.getAllFilesFrontMatter)('posts'),
            d = parseInt(b),
            e = c.slice(i.POSTS_PER_PAGE * (d - 1), i.POSTS_PER_PAGE * d),
            f = { currentPage: d, totalPages: Math.ceil(c.length / i.POSTS_PER_PAGE) }
          return { props: { posts: c, initialDisplayPosts: e, pagination: f } }
        }
...
//# sourceMappingURL=_0gq2mo5._.js.map
