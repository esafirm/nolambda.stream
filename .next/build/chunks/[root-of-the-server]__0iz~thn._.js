          ...
          (err, result) => {
            ...
            if (err) {
              ...
              const loaderPathList = loadersWithOptions.map((l) => {
                try {
                  return /*TURBOPACK member replacement*/ __turbopack_context__.x.resolve(
                    l.loader,
                    {
                      paths: [contextDir, resourceDir],
                    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0iz~thn._.js.map
