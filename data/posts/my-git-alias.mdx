...
tags:
  - 'Git'
  - 'CLI'
summary: 'My Git aliases that I use on daily basis to help me with works and make Git more interactive and efficient'
ogimage: './1.gif'
---
...
![git recent usage](/static/images/posts/git_alias_1.gif)
...
![git del usage](/static/images/posts/git_alias_2.gif)
